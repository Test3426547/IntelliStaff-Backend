import { _ as __nuxt_component_0$1 } from "./nuxt-link-pw9f5qQl.js";
import { _ as _sfc_main$5 } from "./NuxtImg-3DJNeqsf.js";
import { defineComponent, computed, mergeProps, unref, useSSRContext, ref, withAsyncContext, withCtx, createTextVNode, toDisplayString, createVNode, openBlock, createBlock, Fragment, renderList, createCommentVNode, resolveDynamicComponent } from "vue";
import { ssrRenderAttrs, ssrRenderSlot, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrRenderVNode, ssrRenderStyle } from "vue/server-renderer";
import { c as cn, a as useColorMode, _ as _sfc_main$4, G as GlowBorder } from "./GlowBorder-kyYxuHRg.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-1tPrXgE0.js";
import { Sun, Moon, Twitter, Facebook, Linkedin, Instagram } from "lucide-vue-next";
                ...
                createVNode("div", { class: "container mx-auto px-6 py-12" }, [
                  createVNode("div", { class: "grid grid-cols-1 md:grid-cols-4 gap-8" }, [
                    createVNode("div", { class: "col-span-1 md:col-span-2" }, [
                      ...
                      createVNode("p", { class: "text-sm" }, "© " + toDisplayString((/* @__PURE__ */ new Date()).getFullYear()) + " " + toDisplayString(unref(footerContent).businessName) + ". All rights reserved.", 1)
                    ]),
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(() => useAsyncData("footerContent", () => queryContent("layout/footer").findOne())), __temp = await __temp, __restore(), __temp;
...
//# sourceMappingURL=default-CQpC2Jd6.js.map

import { useSSRContext, defineComponent, ref, mergeProps, provide, unref, inject, watch, createVNode, resolveDynamicComponent, withCtx, renderSlot, computed, resolveDirective, withAsyncContext, toDisplayString, defineAsyncComponent, resolveComponent, openBlock, createBlock, Fragment, renderList, createCommentVNode, readonly, createTextVNode } from 'file:///home/runner/workspace/frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderSlot, ssrRenderClass, ssrRenderVNode, ssrRenderList, ssrGetDirectiveProps, ssrInterpolate, ssrRenderComponent } from 'file:///home/runner/workspace/frontend/node_modules/vue/server-renderer/index.mjs';
import { u as useAsyncData, q as queryContent } from './query-BysONKs0.mjs';
import { c as cn, u as useIntervalFn, a as useColorMode, G as GlowBorder, _ as _sfc_main$1$1 } from './GlowBorder-kyYxuHRg.mjs';
import { useSpring } from 'file:///home/runner/workspace/frontend/node_modules/vue-use-spring/dist/index.mjs';
import { _ as _export_sfc } from './_plugin-vue_export-helper-1tPrXgE0.mjs';
import { _ as _sfc_main$h } from './NuxtImg-08wPj5Uz.mjs';
import { MathUtils, SphereGeometry, Vector3, ShaderMaterial, Color } from 'file:///home/runner/workspace/node_modules/three/build/three.module.js';
import './server.mjs';
...
const _sfc_main$g = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const bubbleParentContainer = ref(null);
    ref(null);
    ...
    const PI2 = PI * 2;
    new Array(SPHERE_COUNT).fill(0).map(() => randRange(1) * Math.pow(randRange(), 3));
    ...
    orbitRadii.map((rad, i) => [
      rad * cos(thetas[i]) * sin(phis[i]),
      rad * sin(thetas[i]) * sin(phis[i]),
      rad * cos(phis[i])
    ]);
    new SphereGeometry(SPHERE_SCALE_COEFF);
    getGradientMaterial(
    ...
    function getGradientMaterial(colorBottomWarm, colorTopWarm, colorBottomCool, colorTopCool) {
  ...
  `
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        ref_key: "bubbleParentContainer",
        ref: bubbleParentContainer,
        class: "relative overflow-hidden w-full h-72"
      }, _attrs))}><div></div><div style="${ssrRenderStyle({
        "--bubbles-blur": `${__props.blur}px`
...
_sfc_main$g.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/inspiria/bubbles-bg/BubblesBg.vue");
...
const _sfc_main$f = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["p-2 flex items-center justify-center", __props.containerClass],
        style: { "perspective": "1000px" }
      }, _attrs))}><div class="${ssrRenderClass([
        "flex items-center justify-center relative transition-all duration-200 ease-linear",
        _ctx.$props.class
      ])}" style="${ssrRenderStyle({ "transform-style": "preserve-3d" })}">`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</div></div>`);
    };
  }
...
_sfc_main$f.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/inspiria/card-3d/CardContainer.vue");
...
const _sfc_main$e = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: unref(cn)("h-96 w-96", _ctx.$props.class),
...
_sfc_main$e.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/inspiria/card-3d/CardBody.vue");
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(__props.as), mergeProps({
        ref_key: "refElement",
        ref: refElement,
        class: unref(cn)("w-fit transition duration-500 ease-in-out", _ctx.$props.class)
      }, _attrs), {
...
_sfc_main$d.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/inspiria/card-3d/CardItem.vue");
...
const _sfc_main$c = /* @__PURE__ */ defineComponent({
  ...
  rgba(0, 0, 0, 0) 70%
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="relative z-10">`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</div><div class="pointer-events-none absolute inset-0 rounded-xl opacity-0 transition-opacity duration-300 group-hover:opacity-100" style="${ssrRenderStyle({
        background: backgroundStyle.value,
        opacity: __props.gradientOpacity
      })}"></div></div>`);
    };
  }
});
...
_sfc_main$c.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/inspiria/card-spotlight/CardSpotlight.vue");
...
const _sfc_main$b = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><canvas class="size-full opacity-0 transition-opacity duration-1000 ease-in-out [contain:layout_paint_size]"></canvas></div>`);
    };
  }
});
...
_sfc_main$b.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/inspiria/globe/Globe.vue");
...
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const { pause, resume } = useIntervalFn(
      () => {
        if (iterations.value < props.text.length) {
          displayText.value = displayText.value.map(
            (l, i) => l === " " ? l : i <= iterations.value ? props.text[i] : getRandomLetter()
          );
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "overflow-hidden py-2 flex cursor-default scale-100" }, _attrs))}><div class="flex"><!--[-->`);
      ssrRenderList(displayText.value, (letter, i) => {
        _push(`<span${ssrRenderAttrs(mergeProps({
          key: i,
          class: [unref(cn)(letter === " " ? "w-3" : "", _ctx.$props.class), "font-mono inline-block"],
          initial: { opacity: 0, y: -10 },
          enter: { opacity: 1, y: 0 },
          delay: i * (__props.duration / (__props.text.length * 10))
        }, ssrGetDirectiveProps(_ctx, _directive_motion)))}>${ssrInterpolate(letter.toUpperCase())}</span>`);
      });
      _push(`<!--]--></div></div>`);
    };
  }
...
_sfc_main$a.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/inspiria/hyper-text/HyperText.vue");
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<button${ssrRenderAttrs(mergeProps({
        ...
        style: {
          "--spread": "90deg",
          "--shimmer-color": _ctx.shimmerColor,
          "--radius": _ctx.borderRadius,
          "--speed": _ctx.shimmerDuration,
          "--cut": _ctx.shimmerSize,
          "--bg": _ctx.background
        }
      }, _attrs))} data-v-4150b68c><div class="${ssrRenderClass(
        unref(cn)(
          "-z-30 blur-[2px]",
          "absolute inset-0 overflow-visible [container-type:size]"
        )
      )}" data-v-4150b68c><div class="absolute inset-0 h-[100cqh] animate-shimmer-btn-shimmer-slide [aspect-ratio:1] [border-radius:0] [mask:none]" data-v-4150b68c><div class="animate-shimmer-btn-spin-around absolute -inset-full w-auto rotate-0 [background:conic-gradient(from_calc(270deg-(var(--spread)*0.5)),transparent_0,var(--shimmer-color)_var(--spread),transparent_var(--spread))] [translate:0_0]" data-v-4150b68c></div></div></div>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      ...
      )}" data-v-4150b68c></div><div class="absolute -z-20 [background:var(--bg)] [border-radius:var(--radius)] [inset:var(--cut)]" data-v-4150b68c></div></button>`);
    };
  }
});
...
_sfc_main$9.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/inspiria/shimmer-button/ShimmerButton.vue");
  return _sfc_setup$9 ? _sfc_setup$9(props, ctx) : void 0;
};
const ShimmerButton = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-4150b68c"]]);
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  __name: "TextGenerationEffect",
  __ssrInlineRender: true,
  props: {
    words: {
      type: String,
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "font-bold" }, _attrs))}><div class="mt-4"><div class="dark:text-white text-black text-2xl leading-snug tracking-wide"><div><!--[-->`);
      ssrRenderList(unref(wordsArray), (word, idx) => {
        _push(`<span class="dark:text-white text-black inline-block" style="${ssrRenderStyle(unref(spanStyle))}">${ssrInterpolate(word)}\xA0 </span>`);
      });
...
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/inspiria/text-generation-effect/TextGenerationEffect.vue");
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: content } = ([__temp, __restore] = withAsyncContext(() => useAsyncData("headerHomeContent", () => queryContent("/home/header").findOne())), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        ref_key: "headerRef",
        ref: headerRef,
        class: "p-12 text-center bg-gradient-to-t from-primary/10 from-10% to-transparent"
      }, _attrs))}>`);
      _push(ssrRenderComponent(ShimmerButton, { class: "bg-surface-900 dark:bg-surface-0 text-surface-0 dark:text-surface-900 p-2 mx-auto mb-6 rounded-full max-w-64" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-sm font-medium"${_scopeId}>${ssrInterpolate(unref(content).topPill)}</span>`);
          } else {
            return [
              createVNode("span", { class: "text-sm font-medium" }, toDisplayString(unref(content).topPill), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(unref(_sfc_main$8), {
        words: unref(content).mainHeading,
        class: "text-4xl md:text-6xl text-surface-900 dark:text-surface-0 font-bold"
      }, null, _parent));
      _push(`</div><div class="mb-6">`);
      _push(ssrRenderComponent(unref(_sfc_main$8), {
        words: unref(content).subHeading,
        class: "text-4xl md:text-6xl text-primary font-bold"
      }, null, _parent));
      _push(`</div>`);
      _push(ssrRenderComponent(ShimmerButton, { class: "shadow-2xl font-extrabold" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-lg text-white dark:text-surface-900"${_scopeId}>${ssrInterpolate(unref(content).ctaText)}</span>`);
          } else {
            return [
              createVNode("span", { class: "text-lg text-white dark:text-surface-900" }, toDisplayString(unref(content).ctaText), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`<div class="mt-12 -mb-12"><div class="relative flex flex-col items-center justify-center overflow-hidden rounded-lg border bg-background px-4 md:px-40 pb-40 pt-8 md:pb-60 md:shadow-xl">`);
      _push(ssrRenderComponent(unref(_sfc_main$b), { class: "w-full max-w-3xl" }, null, _parent));
      _push(`<div class="pointer-events-none absolute inset-0 h-full bg-[radial-gradient(circle_at_50%_200%,rgba(0,0,0,0.2),rgba(255,255,255,0))]"></div></div></div></div>`);
    };
  }
});
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/views/home/HomeHeader.vue");
...
var gsap$1, _coreInitted$1, _win$1, _doc$1, _docEl$1, _body$1, _isTouch, _pointerType, ScrollTrigger$1, _root$1, _normalizer$1, _eventTypes, _context$1, _getGSAP$1 = function _getGSAP2() {
  ...
  if (!_coreInitted$1 && gsap$1 && false) {
    _win$1 = void 0;
    _doc$1 = void 0;
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    ref(null);
    const { data: content } = ([__temp, __restore] = withAsyncContext(() => useAsyncData("homeLogosContent", () => queryContent("/home/logos").findOne())), __temp = await __temp, __restore(), __temp);
    const iconComponents = {
      "Notion": defineAsyncComponent(() => import('./NotionIcon-CCE3YJHE.mjs')),
      "GitHub": defineAsyncComponent(() => import('./GitHubIcon-BSr5RQ8-.mjs')),
      "Google": defineAsyncComponent(() => import('./GoogleDriveIcon-UUwXExuC.mjs')),
      "OpenAI": defineAsyncComponent(() => import('./OpenAIIcon-Dx2WMNEe.mjs')),
      "WhatsApp": defineAsyncComponent(() => import('./WhatsAppIcon-CjAB4lSo.mjs'))
    };
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-surface-0 dark:bg-surface-950 px-6 py-20 md:px-12 lg:px-20" }, _attrs))}><div class="flex flex-wrap items-center justify-center gap-8 md:gap-12"><!--[-->`);
      ssrRenderList(unref(content).logos, (logo) => {
        ssrRenderVNode(_push, createVNode(resolveDynamicComponent(iconComponents[logo.name]), {
          key: logo.name,
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/views/home/HomeLogos.vue");
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: content } = ([__temp, __restore] = withAsyncContext(() => useAsyncData("homeFeatureContent", () => queryContent("/home/feature").findOne())), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtImg = _sfc_main$h;
      _push(`<div${ssrRenderAttrs(mergeProps({
        ref_key: "featureRef",
        ref: featureRef,
        class: "bg-surface-0 px-6 py-20 md:px-12 lg:px-20 dark:bg-surface-950 overflow-hidden"
      }, _attrs))}>`);
      _push(ssrRenderComponent(unref(_sfc_main$a), {
        text: unref(content).title,
        class: "text-surface-900 font-bold text-center text-5xl mb-4 dark:text-surface-0",
        duration: 800
      }, null, _parent));
      _push(ssrRenderComponent(unref(_sfc_main$a), {
        text: unref(content).description,
        class: "text-xl leading-7 text-surface-600 dark:text-surface-400 text-center max-w-[96%] lg:max-w-[75%] mx-auto mb-14",
        duration: 800
      }, null, _parent));
      _push(`<div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6"><!--[-->`);
      ssrRenderList(unref(content).features, (feature) => {
        _push(ssrRenderComponent(unref(_sfc_main$c), {
          key: feature.title,
          class: "p-6 bg-surface-50 dark:bg-surface-800 rounded-xl cursor-pointer",
          gradientColor: isDark.value ? "#363636" : "#C9C9C9"
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="w-[3.25rem] h-[3.25rem] bg-surface-900 dark:bg-surface-0 flex items-center justify-center rounded-lg mb-6"${_scopeId}>`);
              ...
              _push2(ssrRenderComponent(unref(_sfc_main$a), {
                text: feature.title,
                class: "text-surface-900 dark:text-surface-0 text-xl font-semibold mb-3",
                duration: 800
              }, null, _parent2, _scopeId));
              _push2(ssrRenderComponent(unref(_sfc_main$a), {
                text: feature.description,
                class: "text-surface-600 dark:text-surface-400 text-lg leading-6",
                duration: 800
              }, null, _parent2, _scopeId));
            } else {
              return [
                createVNode("span", { class: "w-[3.25rem] h-[3.25rem] bg-surface-900 dark:bg-surface-0 flex items-center justify-center rounded-lg mb-6" }, [
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/views/home/HomeFeature.vue");
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    ref(null);
    const isDark = computed(() => useColorMode().value === "dark");
    const { data: blogs } = ([__temp, __restore] = withAsyncContext(() => useAsyncData("sharedBlogContent", () => queryContent("/shared/blog").findOne())), __temp = await __temp, __restore(), __temp);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-surface-50 dark:bg-surface-950 px-6 py-20 md:px-12 lg:px-10 xl:px-20" }, _attrs))} data-v-385ad93a><h2 class="font-bold text-3xl lg:text-5xl text-surface-900 dark:text-surface-0 mb-12 text-center" data-v-385ad93a> Featured Articles </h2><div class="flex flex-col lg:flex-row gap-10 lg:gap-4 xl:gap-12" data-v-385ad93a><!--[-->`);
      ssrRenderList(unref(blogs), (item, index2) => {
        _push(ssrRenderComponent(unref(GlowBorder), {
          key: index2,
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (item.cover) {
                ...
                _push2(`<div class="w-full h-full bg-gray-200 dark:bg-gray-700" data-v-385ad93a${_scopeId}></div>`);
              }
              _push2(`<div class="absolute inset-0 overflow-hidden" data-v-385ad93a${_scopeId}><div class="absolute inset-0 overflow-hidden" data-v-385ad93a${_scopeId}><!--[-->`);
              ssrRenderList(meteors.value, (meteor, i) => {
                _push2(`<span class="${ssrRenderClass([{ "invert": !isDark.value }, "absolute top-1/2 left-1/2 h-0.5 w-0.5 rotate-[215deg] animate-meteor rounded-[9999px] bg-slate-500 shadow-[0_0_0_1px_#ffffff10]"])}" style="${ssrRenderStyle({
                  top: "0px",
                  left: meteor.left,
                  animationDelay: meteor.animationDelay,
                  animationDuration: meteor.animationDuration
                })}" data-v-385ad93a${_scopeId}></span>`);
              });
              _push2(`<!--]--></div></div><div class="p-6" data-v-385ad93a${_scopeId}><span class="${ssrRenderClass([{
              ...
              }, "text-xl block font-medium mb-2"])}" data-v-385ad93a${_scopeId}>${ssrInterpolate(item.category)}</span>`);
              if (item.author) {
                _push2(`<div class="flex items-start gap-2" data-v-385ad93a${_scopeId}>`);
                ...
                _push2(`<div data-v-385ad93a${_scopeId}><div class="text-sm font-bold text-surface-900 dark:text-surface-0 mb-1" data-v-385ad93a${_scopeId}>${ssrInterpolate(item.author.name)}</div><div class="text-sm flex items-center text-surface-700 dark:text-surface-200 gap-2" data-v-385ad93a${_scopeId}><i class="pi pi-calendar text-sm" data-v-385ad93a${_scopeId}></i><span data-v-385ad93a${_scopeId}>${ssrInterpolate(item.date)}</span></div></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
              ...
              return [
                item.cover ? (openBlock(), createBlock(_component_NuxtImg, {
                  key: 0,
                  src: item.cover,
                  alt: item.title,
                  class: "block w-full h-full object-cover"
                ...
                createVNode("div", { class: "absolute inset-0 overflow-hidden" }, [
                  createVNode("div", { class: "absolute inset-0 overflow-hidden" }, [
                    (openBlock(true), createBlock(Fragment, null, renderList(meteors.value, (meteor, i) => {
                      return openBlock(), createBlock("span", {
                        key: i,
                        class: ["absolute top-1/2 left-1/2 h-0.5 w-0.5 rotate-[215deg] animate-meteor rounded-[9999px] bg-slate-500 shadow-[0_0_0_1px_#ffffff10]", { "invert": !isDark.value }],
                        style: {
                          top: "0px",
                          left: meteor.left,
                          animationDelay: meteor.animationDelay,
                ...
                createVNode("div", { class: "p-6" }, [
                  createVNode("span", {
                    class: [{
                      ...
                      "text-pink-600": item.color === "pink",
                      "text-primary": !["blue", "orange", "pink"].includes(item.color)
                    }, "text-xl block font-medium mb-2"]
                  }, toDisplayString(item.category), 3),
                  item.author ? (openBlock(), createBlock("div", {
                    key: 0,
                    class: "flex items-start gap-2"
                  }, [
                    item.author.image ? (openBlock(), createBlock(_component_Avatar, {
                      key: 0,
                      image: item.author.image,
                      alt: item.author.name,
                      shape: "circle",
                    ...
                    createVNode("div", null, [
                      createVNode("div", { class: "text-sm font-bold text-surface-900 dark:text-surface-0 mb-1" }, toDisplayString(item.author.name), 1),
                      createVNode("div", { class: "text-sm flex items-center text-surface-700 dark:text-surface-200 gap-2" }, [
                        createVNode("i", { class: "pi pi-calendar text-sm" }),
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/shared/SharedBlog.vue");
  return _sfc_setup$4 ? _sfc_setup$4(props, ctx) : void 0;
};
const SharedBlog = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-385ad93a"]]);
const _sfc_main$3 = {
  __name: "SharedCTA",
  __ssrInlineRender: true,
  async setup(__props) {
    ...
    gsapWithCSS.registerPlugin(ScrollTrigger);
    ref(null);
    const { data: content } = ([__temp, __restore] = withAsyncContext(() => useAsyncData("sharedCTAContent", () => queryContent("/shared/cta").findOne())), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Button = resolveComponent("Button");
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative bg-surface-900 p-20 flex justify-center md:justify-end overflow-hidden" }, _attrs))} data-v-857a6cad>`);
      _push(ssrRenderComponent(unref(_sfc_main$g), { class: "absolute inset-0 w-full h-full" }, null, _parent));
      _push(`<div class="relative z-10 px-8" data-v-857a6cad><h2 class="text-white font-bold text-6xl" data-v-857a6cad>${ssrInterpolate(unref(content).title1)}</h2><h2 class="text-primary-200 font-bold text-6xl" data-v-857a6cad>${ssrInterpolate(unref(content).title2)}</h2><p class="mt-4 mb-8 text-gray-200 font-medium leading-normal" data-v-857a6cad>${ssrInterpolate(unref(content).description)}</p>`);
      _push(ssrRenderComponent(_component_Button, {
        onClick: unref(content).buttonAction
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="font-bold" data-v-857a6cad${_scopeId}>${ssrInterpolate(unref(content).buttonText)}</span>`);
          } else {
            return [
              createVNode("span", { class: "font-bold" }, toDisplayString(unref(content).buttonText), 1)
            ];
          }
        }),
        _: 1
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/shared/SharedCTA.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const SharedCTA = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-857a6cad"]]);
const _sfc_main$2 = {
  __name: "SharedContactForm",
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    gsapWithCSS.registerPlugin(ScrollTrigger);
    ref(null);
    ref(null);
    const { data: content } = ([__temp, __restore] = withAsyncContext(() => useAsyncData("sharedContactFormContent", () => queryContent("/shared/contact-form").findOne())), __temp = await __temp, __restore(), __temp);
    const contact = ref({
      first_name: "",
      last_name: "",
      email: "",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Button = resolveComponent("Button");
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-surface-0 dark:bg-surface-950" }, _attrs))} data-v-ffea6cc8><div class="flex lg:flex-row flex-col" data-v-ffea6cc8><div class="relative overflow-hidden flex-1 p-8 sm:p-12 xl:p-20" data-v-ffea6cc8>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
        class: "absolute top-0 left-0 w-full h-full object-cover",
        src: unref(content).backgroundImage,
        alt: unref(content).imageAlt
      }, null, _parent));
      _push(`<div class="relative z-20" data-v-ffea6cc8>`);
      _push(ssrRenderComponent(unref(_sfc_main$f), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(_sfc_main$e), { class: "bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(_sfc_main$d), {
                    translateZ: 50,
                    class: "text-3xl font-medium mb-12 text-neutral-600 dark:text-white"
                  }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`${ssrInterpolate(unref(content).title)}`);
                      } else {
                        return [
                          createTextVNode(toDisplayString(unref(content).title), 1)
                        ];
                      }
                    }),
                    _: 1
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$d), {
                    as: "p",
                    translateZ: 60,
                    class: "text-gray-300 leading-normal mb-12 dark:text-neutral-300"
                  }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`${ssrInterpolate(unref(content).description)}`);
                      } else {
                        return [
                          createTextVNode(toDisplayString(unref(content).description), 1)
                        ];
                      }
                    }),
                    _: 1
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$d), {
                    translateZ: 70,
                    as: "a",
                    href: unref(content).mapLink,
                    target: "_blank",
                    class: "inline-flex items-center text-primary-400 font-bold no-underline cursor-pointer"
                  }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<span class="mr-4" data-v-ffea6cc8${_scopeId3}>${ssrInterpolate(unref(content).mapLinkText)}</span><i class="pi pi-arrow-right" data-v-ffea6cc8${_scopeId3}></i>`);
                      } else {
                        return [
                          createVNode("span", { class: "mr-4" }, toDisplayString(unref(content).mapLinkText), 1),
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$d), {
                    translateZ: 80,
                    as: "ul",
                    class: "list-none p-0 m-0 mt-12 text-neutral-600 dark:text-white"
                  }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<!--[-->`);
                        ssrRenderList(unref(content).contactInfo, (item, index2) => {
                          _push4(`<li class="flex items-center mb-4" data-v-ffea6cc8${_scopeId3}><i class="${ssrRenderClass(`pi ${item.icon} mr-2`)}" data-v-ffea6cc8${_scopeId3}></i><span data-v-ffea6cc8${_scopeId3}>${ssrInterpolate(item.text)}</span></li>`);
                        });
                        _push4(`<!--]-->`);
                      } else {
                        return [
                          (openBlock(true), createBlock(Fragment, null, renderList(unref(content).contactInfo, (item, index2) => {
                            return openBlock(), createBlock("li", {
                              key: index2,
                              class: "flex items-center mb-4"
                            }, [
                              createVNode("i", {
                                class: `pi ${item.icon} mr-2`
                              }, null, 2),
            ...
            return [
              createVNode(unref(_sfc_main$e), { class: "bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border" }, {
                default: withCtx(() => [
                  createVNode(unref(_sfc_main$d), {
                    translateZ: 50,
                    class: "text-3xl font-medium mb-12 text-neutral-600 dark:text-white"
      ...
      _push(`</div></div><div class="flex-1 p-8 sm:p-12 xl:p-20 flex flex-col gap-6" data-v-ffea6cc8><div class="w-full flex items-center gap-3" data-v-ffea6cc8>`);
      _push(ssrRenderComponent(_component_InputText, {
        modelValue: contact.value.first_name,
        "onUpdate:modelValue": ($event) => contact.value.first_name = $event,
        class: "w-full flex-1",
        type: "text",
        placeholder: unref(content).form.firstName
      }, null, _parent));
      _push(ssrRenderComponent(_component_InputText, {
        modelValue: contact.value.last_name,
        "onUpdate:modelValue": ($event) => contact.value.last_name = $event,
        class: "w-full flex-1",
        type: "text",
        placeholder: unref(content).form.lastName
      }, null, _parent));
      _push(`</div>`);
      _push(ssrRenderComponent(_component_InputText, {
        modelValue: contact.value.email,
        "onUpdate:modelValue": ($event) => contact.value.email = $event,
        class: "w-full",
        type: "text",
        placeholder: unref(content).form.email
      }, null, _parent));
      _push(ssrRenderComponent(_component_InputText, {
        modelValue: contact.value.phone,
        "onUpdate:modelValue": ($event) => contact.value.phone = $event,
        class: "w-full",
        type: "text",
        placeholder: unref(content).form.phone
      }, null, _parent));
      _push(ssrRenderComponent(_component_Textarea, {
        modelValue: contact.value.message,
        "onUpdate:modelValue": ($event) => contact.value.message = $event,
        rows: "5",
        cols: "30",
        placeholder: unref(content).form.message
      }, null, _parent));
      _push(`<div class="w-full text-right" data-v-ffea6cc8>`);
      _push(ssrRenderComponent(_component_Button, {
        type: "button",
        label: unref(content).form.submitButton,
        icon: "pi pi-envelope",
        class: "px-8 py-4 w-auto"
      }, null, _parent));
      _push(`</div></div></div></div>`);
    };
  }
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/shared/SharedContactForm.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const SharedContactForm = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-ffea6cc8"]]);
const _sfc_main$1 = {
  __name: "SharedFAQ",
  __ssrInlineRender: true,
  async setup(__props) {
    ...
    gsapWithCSS.registerPlugin(ScrollTrigger);
    ref(null);
    const { data: content } = ([__temp, __restore] = withAsyncContext(() => useAsyncData("sharedFAQContent", () => queryContent("/shared/faq").findOne())), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-surface-50 dark:bg-surface-950 px-6 py-12 md:px-12" }, _attrs))} data-v-de338727><h2 class="block font-bold text-3xl mb-8 text-center text-surface-900 dark:text-surface-0" data-v-de338727>${ssrInterpolate(unref(content).title)}</h2><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 p-4 gap-8 md:gap-x-4 md:gap-y-8 lg:gap-8" data-v-de338727><!--[-->`);
      ssrRenderList(unref(content).faqs, (item, index2) => {
        _push(ssrRenderComponent(unref(_sfc_main$1$1), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<h3 class="font-medium text-xl text-surface-900 dark:text-surface-0 mb-4" data-v-de338727${_scopeId}>${ssrInterpolate(item.title)}</h3><p class="text-surface-700 dark:text-surface-100 leading-normal" data-v-de338727${_scopeId}>${ssrInterpolate(item.description)}</p>`);
            } else {
              return [
                createVNode("h3", { class: "font-medium text-xl text-surface-900 dark:text-surface-0 mb-4" }, toDisplayString(item.title), 1),
                createVNode("p", { class: "text-surface-700 dark:text-surface-100 leading-normal" }, toDisplayString(item.description), 1)
              ];
            }
          }),
          _: 2
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/shared/SharedFAQ.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const SharedFAQ = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-de338727"]]);
const _sfc_main = {
  __name: "index",
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    const { data: headerContent } = ([__temp, __restore] = withAsyncContext(() => useAsyncData("headerContent", () => queryContent("/home/header").findOne())), __temp = await __temp, __restore(), __temp);
    const { data: logosContent } = ([__temp, __restore] = withAsyncContext(() => useAsyncData("logosContent", () => queryContent("/home/logos").findOne())), __temp = await __temp, __restore(), __temp);
    const { data: featureContent } = ([__temp, __restore] = withAsyncContext(() => useAsyncData("featureContent", () => queryContent("/home/feature").findOne())), __temp = await __temp, __restore(), __temp);
    const { data: blogContent } = ([__temp, __restore] = withAsyncContext(() => useAsyncData("blogContent", () => queryContent("/shared/blog").findOne())), __temp = await __temp, __restore(), __temp);
    const { data: ctaContent } = ([__temp, __restore] = withAsyncContext(() => useAsyncData("ctaContent", () => queryContent("/shared/cta").findOne())), __temp = await __temp, __restore(), __temp);
    const { data: contactFormContent } = ([__temp, __restore] = withAsyncContext(() => useAsyncData("contactFormContent", () => queryContent("/shared/contact-form").findOne())), __temp = await __temp, __restore(), __temp);
    const { data: faqContent } = ([__temp, __restore] = withAsyncContext(() => useAsyncData("faqContent", () => queryContent("/shared/faq").findOne())), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<main${ssrRenderAttrs(_attrs)} data-v-6f19a43f>`);
      if (unref(headerContent)) {
        _push(ssrRenderComponent(_sfc_main$7, { content: unref(headerContent) }, null, _parent));
      } else {
        _push(`<!---->`);
      }
      if (unref(logosContent)) {
        _push(ssrRenderComponent(_sfc_main$6, { content: unref(logosContent) }, null, _parent));
      } else {
        _push(`<!---->`);
      }
      if (unref(featureContent)) {
        _push(ssrRenderComponent(_sfc_main$5, { content: unref(featureContent) }, null, _parent));
      } else {
        _push(`<!---->`);
      }
      if (unref(blogContent)) {
        _push(ssrRenderComponent(SharedBlog, { content: unref(blogContent) }, null, _parent));
      } else {
        _push(`<!---->`);
      }
      if (unref(ctaContent)) {
        _push(ssrRenderComponent(SharedCTA, { content: unref(ctaContent) }, null, _parent));
      } else {
        _push(`<!---->`);
      }
      if (unref(contactFormContent)) {
        _push(ssrRenderComponent(SharedContactForm, { content: unref(contactFormContent) }, null, _parent));
      } else {
        _push(`<!---->`);
      }
      if (unref(faqContent)) {
        _push(ssrRenderComponent(SharedFAQ, { content: unref(faqContent) }, null, _parent));
      } else {
        _push(`<!---->`);
      }
      _push(`</main>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6f19a43f"]]);

export { index as default };
//# sourceMappingURL=index-DFTWm-FY.mjs.map

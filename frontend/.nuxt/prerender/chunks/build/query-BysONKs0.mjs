import { ref, shallowRef, toRef, getCurrentInstance, onServerPrefetch, unref } from 'file:///home/runner/workspace/frontend/node_modules/vue/index.mjs';
import { c as useNuxtApp, f as asyncDataDefaults, g as createError, b as useRuntimeConfig, h as useRequestEvent } from './server.mjs';
import { withLeadingSlash, joinURL, withoutTrailingSlash, withBase } from 'file:///home/runner/workspace/frontend/node_modules/ufo/dist/index.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-D_1zxSEs.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-BysONKs0.mjs.map

...
import { c as useNuxtApp, f as asyncDataDefaults, g as createError, b as useRuntimeConfig } from './server.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-BWv3DRhJ.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-Csgz12rX.mjs.map
